...
class ToolSchemaRegistry:
    ...
    def validate_tool_call(self, tool_name: str, tool_call: Dict[str, Any]) -> tuple[bool, Optional[str]]:
        """
        ...
        if tool_call.get("name") != tool_name:
            return False, f"Tool name mismatch: expected '{tool_name}', got '{tool_call.get('name')}'"
