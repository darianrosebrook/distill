...
class ScenarioEvaluator:
    ...
    def _judge_evaluation(self, student_output: str, teacher_output: str, rubric: Dict[str, Any]) -> float:
...
def main(
    ...
    teacher_outputs_path: Optional[str] = typer.Option(None, help="Path to teacher outputs JSONL file"),
    baseline_outputs_path: Optional[str] = typer.Option(None, help="Path to baseline outputs JSONL file"),
    output_path: str = typer.Option("eval/scenario_results.json", help="Output path for evaluation results"),
    role: Optional[str] = typer.Option(None, help="Filter scenarios by role (worker/judge/drafter)"),
):
    """
