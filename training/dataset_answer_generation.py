"""
Dataset loader for answer generation training stage.

Loads answer generation JSONL format:
{
    "input": {
        "system": "...",
        "tools": [...],
...
class AnswerGenerationDataset(Dataset):
    """
    Dataset for answer generation training.

    Each example contains:
    - Input: Full context (system, tools, history, tool results)
    - Target: Final answer or code
    """
    ...
    def __init__(
        ...
        """
        Initialize answer generation dataset.

        Args:
            data_path: Path to answer generation JSONL file
...
def collate_answer_generation_batch(batch: List[Dict[str, Any]]) -> Dict[str, torch.Tensor]:
    """
    Collate function for answer generation dataset.
