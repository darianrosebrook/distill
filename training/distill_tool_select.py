...
def train_step(
    ...
    with torch.cuda.amp.autocast(enabled=scaler is not None):
        ...
        if proc_cfg.get("json_validity_weight", 0.3) > 0 or proc_cfg.get("tool_select_weight", 0.7) > 0:
        ...
        # Combined loss
        total_loss = ce_loss + json_validity_weight * json_loss + tool_select_weight * tool_select_loss
