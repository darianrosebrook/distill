...
def generate_cost_chart(output_dir):
    ...
    # Purple for M8B, grey for others
    colors = ["#8B5CF6", "#6B7280", "#6B7280", "#6B7280"]
    bars = ax.bar(models, costs, color=colors, edgecolor="#ffffff", linewidth=1.5, alpha=0.8)
...
def generate_throughput_chart(output_dir):
    ...
    # Purple for M8B, grey for others
    colors = ["#8B5CF6", "#6B7280", "#6B7280", "#6B7280"]
    bars = ax.bar(models, throughput, color=colors, edgecolor="#ffffff", linewidth=1.5, alpha=0.8)
    ...
    ax.set_yscale("log")
    ax.set_ylabel(
        "Throughput (inferences/sec per $, log scale)",
        fontsize=12,
        fontweight="bold",
        color="white",
    )
...
def generate_efficiency_multipliers_chart(output_dir):
    ...
    # Purple for M8B, grey for others
    colors = ["#8B5CF6", "#6B7280", "#6B7280", "#6B7280"]
    bars = ax.bar(models, multipliers, color=colors, edgecolor="#ffffff", linewidth=1.5, alpha=0.8)
...
def generate_billion_scale_savings_chart(output_dir):
    ...
    bars = ax.bar(models, savings, color=colors, edgecolor="#ffffff", linewidth=1.5, alpha=0.8)
