...
def bytes_to_token_span(
    text: str, start: int, end: int, tokenizer
...
def normalize_text_for_alignment(text: str, text_norm: Optional[str] = None, line_endings: Optional[str] = None) -> str:
    """
