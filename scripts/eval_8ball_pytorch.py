...
def evaluate_8ball_quality(response):
    ...
    mystical_phrases = [
        ...
        "signs point to yes", "reply hazy", "ask again later", "better not tell you now",
    ...
    fortune_like = len(response.split()) <= 10 and ('yes' in response_lower or 'no' in response_lower or 'maybe' in response_lower or 'ask' in response_lower)
...
def main():
    ...
    if valid_results:
        ...
        print("
📊 EVALUATION SUMMARY:"        print(f"  Average Score: {avg_score:.2f}")
...
if __name__ == "__main__":
    main()
EOF && echo "" && echo "✅ Created evaluation script!" && echo "" && echo "🔬 RUNNING PYTORCH EVALUATION..." && echo "================================" && source venv/bin/activate && PYTHONPATH=/Users/darianrosebrook/Desktop/Projects/distill python scripts/eval_8ball_pytorch.py --model-path outputs/8ball_demo/model.pt --output results/8ball_demo_eval.json