...
## Summary
- Total files: 35995
- Non-ignored files: 306
- Ignored files: 35689
- Files with hidden TODOs: 45
- Total hidden TODOs found: 4505
- Code stub detections: 4
- High confidence TODOs (≥0.9): 4502
...
## Pattern Statistics
- `\bfor\s+now\b(?!(_|\.|anal|\sanal|s))`: 3867 occurrences
- `\bsimplified\b(?!(_|\.|anal|\sanal|s))`: 504 occurrences
- `\bPLACEHOLDER\b`: 122 occurrences
- `\bPLACEHOLDER\b.*?:`: 100 occurrences
- `\bTODO\b(?!(_|\.|anal|\sanal|s))`: 4 occurrences
...
- `conversion/convert_coreml.py` (python): 7 high-confidence TODOs
...
- `coreml/runtime/ane_monitor.py` (python): 3 high-confidence TODOs
- `training/quant_qat_int8.py` (python): 2 high-confidence TODOs
- `training/run_toy_distill.py` (python): 2 high-confidence TODOs
...
- `training/losses.py` (python): 1 high-confidence TODOs
- `training/distill_kd.py` (python): 1 high-confidence TODOs
...
- `coreml/runtime/speculative_decode.py` (python): 1 high-confidence TODOs
...
- `conversion/export_pytorch.py` (python): 1 high-confidence TODOs
...
### `scripts/assess_readiness.py:386` (python)
...
### Explicit Todos (4495 items)
#### High Confidence (4493 items)
- `mutants/training/quant_qat_int8.py:11481` (python, conf: 1.0 (context: 0.0)): For now, we'll use a simple approach: quantize the embedding weights...
- `mutants/training/quant_qat_int8.py:11486` (python, conf: 1.0 (context: 0.0)): For now, we'll leave it as-is and document the trade-off...
- `mutants/training/quant_qat_int8.py:11565` (python, conf: 1.0 (context: 0.0)): For now, we'll use a simple approach: quantize the embedding weights...
- ... and 4490 more high-confidence items
...
- `training/claim_extraction.py:11` (python, conf: 0.8 (context: -0.5)): Claim extraction utilities for training dataset generation and loss computation....
