...
class TestMHAGQA:
    ...
    def test_mha_gqa_forward(self, device, small_model_cfg):
        ...
        rope = RotaryEmbedding(small_model_cfg.d_head, small_model_cfg.rope_theta, small_model_cfg.rope_scaling)
        mha = MHA_GQA(
    ...
    def test_mha_gqa_forward_decode(self, device, small_model_cfg):
        ...
        assert kv_cache2[0].shape == (b, small_model_cfg.n_kv_heads, 2, small_model_cfg.d_head)  # Cache grows
