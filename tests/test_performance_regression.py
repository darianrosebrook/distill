...
def check_performance_regression(
    ...
    tps_p50_regression = (
        baseline.tokens_per_second_p50 - current.tokens_per_second_p50
    ) / baseline.tokens_per_second_p50
    tps_p95_regression = (
        baseline.tokens_per_second_p95 - current.tokens_per_second_p95
    ) / baseline.tokens_per_second_p95
