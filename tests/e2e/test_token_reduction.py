...
class TestTokenReductionE2E:
    ...
    def test_token_reduction_at_equal_accuracy(self, mock_model, mock_tokenizer, long_chain_task):
        ...
        baseline_metrics = self.test_baseline_direct_cot(mock_model, mock_tokenizer, long_chain_task)
        
        # Get latent metrics
        latent_metrics = self.test_latent_mode_token_reduction(mock_model, mock_tokenizer, long_chain_task)
