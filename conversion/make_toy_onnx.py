...
def main():
    ...
    attention_mask = helper.make_tensor_value_info('attention_mask', TensorProto.INT32, [1, T])  # unused, for interface parity
    ...
    nodes.append(helper.make_node('Reshape', ['emb',], ['emb2'], [], domain='', ))
    # Reshape to [T,D]
    ...
    graph = helper.make_graph(nodes, 'toy_graph', [input_ids, attention_mask], [logits],
