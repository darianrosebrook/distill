...
class SpeculativeDecoder:
    ...
    def generate(
        ...
        while len(tokens) < max_tokens:
            ...
            accepted = self._verify_tokens(
                draft_tokens, current_input, worker_state
            )
    ...
    def _verify_tokens(
        ...
        for draft_token in draft_tokens:
            ...
            if self._should_accept_draft_token(draft_token, worker_logits):
    ...
    def _should_accept_draft_token(
        ...
        Uses standard speculative decoding acceptance criterion:
        Accept if worker's probability for draft token is reasonable.
        ...
        # This is a simplified criterion; production would use more sophisticated logic
