...
Provides the 8-ball specific ClassificationConfig instance and utility functions.
This module can be imported by the general classification evaluation framework.
...
# Reverse mapping
ANSWER_TO_ID = {answer: token_id for token_id, answer in ID_TO_ANSWER.items()}
