...
Below, we break down these requirements and the components needed – essentially a "bill of materials" for the arbiter stack – along with relevant research and recommended practices to guide the design.
...
interface PerformanceThresholds {
  ...
  // High-performance reference metrics
  highPerformance: {
...
interface NewModelPipeline {
  ...
  integrationCriteria: {
    performanceImprovement: 0.1; // 10% improvement over baseline
